...
public class SearchResultsGui extends PagedCustomGui {

    private final PluginMessenger pluginMessenger;

    public SearchResultsGui(String searchInput, Player player, PagedGuiHandler pagedGuiHandler, PluginMessenger pluginMessenger, TeleportationBukkit plugin) {
        super("Suche: %s".formatted(searchInput), PagedGuiType.SEARCH_RESULTS, Skulls.Skin.WARP_HOUSE, player, pagedGuiHandler, plugin, searchInput);
