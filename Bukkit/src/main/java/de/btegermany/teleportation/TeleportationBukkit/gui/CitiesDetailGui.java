...
public class CitiesDetailGui extends MultiplePagesDetailWarpGuiAbstract {

    public CitiesDetailGui(Player player, String city, PluginMessenger pluginMessenger, JSONArray contentJSON, RegistriesProvider registriesProvider) {
        ...
        inventory.addHandler(new PagedInventorySwitchPageHandler() {
            ...
            public void handle(SwitchHandler switchHandler) {
                ...
                pluginMessenger.send(new GetGuiDataMessage(registriesProvider, pluginMessenger, player.getUniqueId().toString(), "city_" + city, inventory.getSize()));
            }
        });
    }
