...
public class CityGui extends PagedCustomGui {

    private final PluginMessenger pluginMessenger;

    public CityGui(String city, Player player, PagedGuiHandler pagedGuiHandler, PluginMessenger pluginMessenger, TeleportationBukkit plugin) {
        super(city, PagedGuiType.CITY, Skulls.Skin.WARP_HOUSE, player, pagedGuiHandler, plugin, city);
