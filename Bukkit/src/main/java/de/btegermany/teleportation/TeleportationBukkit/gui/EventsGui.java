...
public class EventsGui extends MultiPageDetailWarpGuiAbstract {

    public EventsGui(MultiPageGuiArgs guiArgs) {
        super(guiArgs, "Events", Skulls.Skin.WARP_HOUSE.getId());
    }
