...
public class LobbyWarpAroundGui extends MultiplePagesDetailWarpGuiAbstract {

    public LobbyWarpAroundGui(Player player, String title, PluginMessenger pluginMessenger, JSONArray contentJSON, RegistriesProvider registriesProvider) {
        super(player, title, pluginMessenger, contentJSON, Skulls.Skin.WARP_HOUSE.getId(), registriesProvider);
    }
