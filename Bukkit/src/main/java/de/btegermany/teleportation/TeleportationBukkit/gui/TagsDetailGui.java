...
public class TagsDetailGui extends MultiPageDetailWarpGuiAbstract {

    public TagsDetailGui(MultiPageGuiArgs guiArgs, String tag) {
        super(guiArgs, tag, Skulls.Skin.WARP_HOUSE.getId());
