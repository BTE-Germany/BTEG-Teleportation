...
public class StateGui extends PagedCustomGui {

    private final PluginMessenger pluginMessenger;

    public StateGui(String state, Player player, PagedGuiHandler pagedGuiHandler, PluginMessenger pluginMessenger, TeleportationBukkit plugin) {
        super(state, PagedGuiType.STATE, Skulls.Skin.WARP_HOUSE, player, pagedGuiHandler, plugin, state);
