...
public class PlotsGui extends PagedCustomGui {

    private final PluginMessenger pluginMessenger;

    public PlotsGui(Player player, PagedGuiHandler pagedGuiHandler, PluginMessenger pluginMessenger, TeleportationBukkit plugin) {
        super("Plotgebiete", PagedGuiType.PLOT_REGIONS, Skulls.Skin.WARP_HOUSE, player, pagedGuiHandler, plugin);
