...
public class AllGui extends PagedCustomGui {

    private final PluginMessenger pluginMessenger;

    public AllGui(Player player, PagedGuiHandler pagedGuiHandler, PluginMessenger pluginMessenger, TeleportationBukkit plugin) {
        super("Alle Warps", PagedGuiType.ALL, Skulls.Skin.WARP_HOUSE, player, pagedGuiHandler, plugin);
